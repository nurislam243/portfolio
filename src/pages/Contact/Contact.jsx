...
const Contact = () => {
  return (
    <section id="contact" className="pt-[100px] sm:pt-[120px] pb-[120px] bg-base-200 px-4 @min-[400px]:px-6 @min-[500px]:px-7 @min-[600px]:px-9 @min-[900px]:px-10 @min-[1100px]:px-[52px] @min-[1400px]:px-0">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-base-100 rounded-xl shadow-xl">
          ...
          <div className="grid md:grid-cols-2 gap-10 p-8 border-t border-gray-800">
            {/* Contact Info */}
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-base-content">mdnurislam15177@gmail.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-base-content">+8801778249088</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
